...
export class CategoriesComponent implements OnInit {
  ...
  this.auth.isLogin((result:any) => {
    ...
    this.categories.getCategorypage({pageSize:this.pageSize,pageIndex:0},(result:any) => {
    ...
    this.categories.getCategoryCount((result:any) => {
  ...
  setCurrentPage(){
    this.categories.getCategorypage({pageSize:this.pageSize,pageIndex:(this.curIndex*this.pageSize)},(result:any) => {
      this.listOfCategories = result
    })
  ...
  doSearch(searchData:any){
    ...
    this.categories.searchCategory(searchObj,(result:any) => {
      console.log("Search Result",result)
      this.listOfCategories = result
    })
    this.categories.searchCategoryCount(searchObj, (result:any) => {
  ...
  removeCategory(category:any){
    category.status = '0'
    this.categories.removeCategory(category,(result:any) => {
...
export class CategoryDialog {
  ...
  onYesClick(dataa: DialogData): void {
    ...
    this.categories.removeCategory(this.obj, (result:any) => {
