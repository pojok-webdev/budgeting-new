...
*/
  ...
  updatePrice(){
    this.submissionService.updateFinalPriceBySubmissionId({final_price:this.submission.final_price,submissionId:this.submissionId},(res:any)=>{
      ...
      dialogRef.afterDismissed().subscribe(data=>{*/
        ...
        this.submissionService.setSubmissionDetailStatusBySubmissionId({id:this.submissionId,status:7},(res:any)=>{
  ...
  rejectSubmission(){
    this.submissionService.updateFinalPriceBySubmissionId({final_price:this.submission.final_price,submissionId:this.submissionId},(res:any)=>{
      ...
      this.submissionService.setSubmissionDetailStatusBySubmissionId({id:this.submissionId,status:3},(res:any) => {
        this.submissionService.updateRejectReasonBySubmissionId(
          {
            submissionId:this.submissionId, 
  ...
  notificationMail(obj:any,callback:any){
  ...
  warehouseAlert(obj:any,callback:any){
