...
current_budget:any
budgetused:any
budget_limit_city:any
budgetused_city:any
budget_approve_city:any
...
tempTotalPrice:any
  constructor(
    ...
    this.getSubmissionId((id:any)=>{
      this.submissionService.getSubmissionById(id,(submission:any)=>{
        ...
        this.getQuarter(this.month,(quarter:any)=>{
          this.getDivision({user:submission[0].createuser},(division:any)=>{
            this.getBudgets({month:this.month,year:this.year,quarter:quarter,division:division})
          })
        })
      })
      this.submissionService.getSubmissionDetailBySubmissionId(id,(submissions:any)=>{
        ...
        this.submissionService.getSubmissionDetailVendor(submissions[0].id,(vendors:any)=>{
  ...
  getQuarter(month:any,callback:any){
  ...
  getSubmissionId(callback:any){
    callback(this.activatedRoute.snapshot.paramMap.get('id'))
  }
  ngOnInit() {
  }
  getDivision(obj:any,callback:any){
    this.userService.getuserByName(obj.user, (result:any) =>{
  ...
  getTotalPrice(submission_detail_id:any,callback:any){
    ...
    this.totalPrice = 0
    this.submissionService.getSubmissionDetailBySubmissionId(this.submission.id,(result:any) =>{
      console.log("submission detail result",result)
      this.submissionService.getSubmissionDetails(submission_detail_id,(result:any) => {
          ...
          dialogRef.afterClosed().subscribe(result => {
            ...
            if(result != null){
              ...
              if(result.approvalStatus == this.dialogResult.approved){
                if(this.useVendorComparisonData == true){
                  ...
                  this.submissionService.updatesubmissiondetail(this.submission_detail, (result:any) => {
                    if(result != null){
                      ...
                      this.submissionService.setSubmissionDetailStatus({id:this.submission_detail.id,status:2},(resultUpdated:any)=>{
                ...
                this.submissionService.setSubmissionDetailStatus({id:this.submission_detail.id,status:3},(resultUpdated:any)=>{
                  console.log('resultUpdated',resultUpdated)
