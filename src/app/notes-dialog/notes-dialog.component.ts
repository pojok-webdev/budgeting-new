...
notes:any
  constructor(
    ...
    this.noteService.getBySubmissionId({submission_id:data.submissionId},(notes:any)=>{
  ...
  addNote(){
    ...
    dialog.afterClosed().subscribe(data=>{
      this.noteService.getBySubmissionId({submission_id:this.data.submissionId},(notes:any)=>{
        console.log("Res get notes",notes)
        this.notes = notes
      })  
    })
