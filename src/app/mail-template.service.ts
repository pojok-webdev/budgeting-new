...
export class MailTemplateService {
  ...
  constructor() { }
  submissionCreateNotification(obj:any){
  ...
  submissionVerifiedNotification(obj:any){
  ...
  submissionRejectedNotification(obj:any){
